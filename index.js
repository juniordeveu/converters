...
{ /* block with functions calculating percents */
...
function PercentOfOneNumbIsOtherNumb(){
    ...
    calc_2.calculation2()
console.log("Jakim procentem jednej liczby jest druga liczba  to = : ",calc2.result_2)
}
function NumWithPercent(){
    let calc3 = new Percents
    calc3.calculation3()
console.log("Jakim procentem jednej liczby jest druga liczba  to = : ",calc3.result_3)
}
